...
func main() {
	...
	nodeHandler := handlers.NewNodeHandler(userService, nodeService, ruleService, siteConfigService)
	ruleHandler := handlers.NewRuleHandler(ruleService, nodeService, userService)
